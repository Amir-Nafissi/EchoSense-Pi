...
We ran into many challenges during the production of EchoSense which almost made us abandon the project. One of the main challenges we ran into is to get the audio to work whenever it detects an object coming nearby. The other challenge was to get the app to connect with the Raspberry Pi (which was not successful at the end). And biggest challenge that took the longest to overcome was the Raspberry Pi OS to work with the modules.
